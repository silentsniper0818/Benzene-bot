...
module.exports = {
  ...
  BOT_NAME: process.env.BOT_NAME || 'BENZENE BOT',
  ...
  BOT_INFO: process.env.BOT_INFO || 'BENZENE; BENEDICT;2347067359270;https://i.imgur.com/6oRG106.jpeg',
  AUDIO_DATA: process.env.AUDIO_DATA || 'ʜᴇʀᴍɪᴛ;ᴀᴅɪᴛʜyᴀɴ;https://i.imgur.com/fj2WE83.jpeg',
  STICKER_DATA: process.env.STICKER_DATA || 'BENZENE',
